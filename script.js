(function() {
    ...
    function checkoutCart(event) {
        ...
        if (discountCode === 'SECRET_50') {
            alert('Geheimer Rabattcode angewendet!');
            totalPrice *= 0.5;
        }
    ...
    function checkAdminAccess() {
        ...
        if (isAdmin) {
            ...
            alert('Zugriff verweigert! Setze das richtige Cookie.');
        }
    }
    ...
    function renderCart() {
        ...
        orderedItems.innerHTML += `
            <div class="space-between mb-8 mt-8"><b>Zwischensumme</b> <div>${sum.toFixed(2)}€</div></div>
            <div class="space-between mb-8"><b>Versandkosten</b> <div>${4.99}€</div></div>
            <div class="space-between mb-8"><b>Gesamtsumme</b> <div>${(sum + 4.99).toFixed(2)}€</div></div>`;
    }
